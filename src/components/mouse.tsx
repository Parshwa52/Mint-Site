  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      window.addEventListener("click", () => {
        // Don't initiate click animation if drag cursor is on
        if (document.getElementById("drag-text")?.style.display !== "block") {
  ...
  return (
    <div id="mouse">
      ...
      <div className="mouse-container">
        ...
        <p id="drag-text" className="mouse-drag-text text-center">
          Drag
        </p>
      </div>
    </div>
