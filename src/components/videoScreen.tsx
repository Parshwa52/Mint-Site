  ...
  return (
    <div className="relative h-screen">
      ...
      <div className="absolute items-center justify-end flex w-full top-0 p-4 ">
        <a href="#" className="mr-4 text-[22px] font-semibold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">
          0x132yg312g3g13
        </a>
      </div>

      <div className="absolute items-center justify-center flex w-full mt-[130px] top-0 p-4 ">
        <a href="#" className="mr-4 text-[26px] font-semibold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">
